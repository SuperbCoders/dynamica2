...
(function (factory) {
        ...
        fill: function () {
            ...
            while (prevMonth.valueOf() < nextMonth) {
                ...
                if (this.o.beforeShowDay !== $.noop) {
                    var before = this.o.beforeShowDay(this._utc_to_local(prevMonth), this);
                    if (before === undefined)
                        before = {};
    ...
    var DPGlobal = {
        ...
        '</tr>' +
        '<tr>' +
        '<th class="prev"><i class="icon fa fa-angle-left"></i></th>' +
        '<th colspan="5" class="datepicker-switch"></th>' +
        '<th class="next"><i class="icon fa fa-angle-right"></i></th>' +
        '</tr>' +
        '</thead>',
