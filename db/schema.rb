...
ActiveRecord::Schema.define(version: 20161217123943) do
  ...
  add_index "subscription_prices", ["sub_type"], name: "index_subscription_prices_on_sub_type", using: :btree
  ...
  create_table "users", force: true do |t|
    ...
    t.string   "avatar"
    t.string   "role"
    t.boolean  "news_notification"
    t.boolean  "subscription_notification"
  end
